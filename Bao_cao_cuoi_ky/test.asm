...
#Khai bao khong gian luu chu cho chuoi nhap vao, cac o dia 
...
clear_string:
	...
	beq		$t0, 10, clear_disk1		# So sanh ky tu do voi ky tu '\n', neu bang chuyen qua nhan clear_disk1
